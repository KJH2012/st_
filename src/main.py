...
def song_cover_pipeline(song_input, voice_model, pitch_change, keep_files,
    ...
    try:
        ...
        orig_song_path = './vocoder_integrated.wav'
        main_vocals_dereverb_path = './vocoder_integrated.wav'
        vocals_path = './vocoder_integrated.wav'
        instrumentals_path = './vocoder_integrated.wav'
        main_vocals_path = './vocoder_integrated.wav'
        backup_vocals_path = './vocoder_integrated.wav'
